  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-[#e9ecf2] rounded-[8px] bg-white text-[#1d1d25] hover:bg-[#f9faff] hover:border-[#d1d5db] transition-colors duration-200 group"
      >
